		...
		var t = {
				...
				187: (t, r, e) => {
					...
					t.exports = function (t) {
						...
						return (
							["corePath", "workerPath", "langPath"].forEach(
								function (e) {
									t[e] && (r[e] = a(r[e]));
								}
							),
							...
							return new Promise(function (r, e) {
								...
								(n.onload = function () {
									...
									(n.onerror = function (t) {
										...
										e(
											Error(
												"File could not be read! Code=".concat(
													r
												)
											)
										);
